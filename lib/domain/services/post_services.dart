...
class PostServices {
  Future<DefaultResponse> addNewPost(String post_emotion, String comment,
      String typePrivacy, List<File> images) async {
    ...
    var request = http.MultipartRequest(
      ...
      ..fields['post_emotion'] = post_emotion
  ...
  Future<List<Post>> getAllPostHome() async {
    ...
    print(ResponsePost.fromJson(jsonDecode(resp.body)).posts);
  ...
  Future<DefaultResponse> deletePostByUser(String uidPost) async {
    ...
    final resp = await http.post(
        Uri.parse('${Environment.urlApi}/post/delete-post-by-user'),
        headers: {'Accept': 'application/json', 'xxx-token': token!},
        body: {'post_uid': uidPost});
