                  ...
                  builder: (_, snapshot) {
                    ...
                    return !snapshot.hasData
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (_, i) {
                              if (snapshot.data![i].emotion != "negative") {
                                return _ListViewPosts(posts: snapshot.data![i]);
                              }
                              return Container(
                                height: 0,
                                width: 0,
              ...
              if (state.user != null) {
                return InkWell(
                  onTap: () => Navigator.push(
                    context,
                    routeSlide(page: const AddStoryPage()),
                  ),
                  child: Column(
                      ...
                      Container(
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundImage: NetworkImage(
                            Environment.baseUrl + state.user!.image.toString(),
                          ),
                        ),
                      ),
                      const SizedBox(height: 5.0),
