...
class adminHomePagee extends StatefulWidget {
  const adminHomePagee({Key? key}) : super(key: key);

  @override
  State<adminHomePagee> createState() => _HomePageState();
}

class _HomePageState extends State<adminHomePagee> {
  @override
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    content: GestureDetector(
                                      onTap: () => postBloc.add(
                                          OndelNewPostEvent(posts.postUid)),
